"""Ligand manifest auditing and preparation helpers.

Consolidated from ``scripts/check_ligand_smiles.py`` and
``scripts/prepare_ligand_3d_sdf.py``; behavior is identical to the originals.
"""
