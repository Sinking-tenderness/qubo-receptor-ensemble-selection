...
run_dir="results/runs/stage52b_ppara_train374_unidock113_production"
progress="$run_dir/progress.json"
summary="$run_dir/summary.json"
audit="data/stage52b_ppara_train374_unidock113_production_audit.json"
...
receptor_manifest="data/processed/stage52b_ppara_stage51_passing20_receptor_manifest.csv"
receptor_summary="data/stage52b_ppara_stage51_passing20_receptor_manifest_summary.json"
preregistration="configs/stage52_ppara_posthoc_exploratory_development_preregistration.json"
input_audit="data/stage52a_ppara_train374_unidock_inputs_independent_audit.json"
ligand_manifest="data/processed/stage52a_ppara_train374_unidock_pdbqt_manifest.csv"
ligand_summary="data/stage52a_ppara_train374_unidock_input_summary.json"

partition="${PARTITION_ID:-${SEED_IDS:-all}}"
partition="${partition//,/+}"
partition="${partition//[^A-Za-z0-9_+-]/_}"
core_archive="$output_root/stage52b_ppara_train374_unidock113_production_core_v1.tar.gz"
diagnostic_archive="$output_root/stage52b_ppara_train374_unidock113_production_diagnostics_v1.tar.gz"
checkpoint_archive="$output_root/stage52b_ppara_train374_unidock113_${partition}_checkpoint_v1.tar.gz"
failure_archive="$output_root/stage52b_ppara_train374_unidock113_${partition}_failed_diagnostics_v1.tar.gz"
...
runner=(
  "$python_bin"
  -m
  scripts.experimental.unidock.run_stage52b_ppara_train374_production
  --config "$config"
)
...
if [[ -f "$summary" ]]; then
  "$python_bin" -m scripts.experimental.unidock.audit_stage52b_ppara_train374_production \
    --config "$config"
