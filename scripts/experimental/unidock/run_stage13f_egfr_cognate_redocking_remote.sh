...
run_dir="results/runs/stage13f_egfr_cognate_redocking"
summary="data/stage13f_egfr_cognate_redocking_summary.json"
results="data/processed/stage13f_egfr_cognate_redocking_results.csv"
gate_results="data/processed/stage13f_egfr_receptor_gate_results.csv"
core_archive="$output_root/stage13f_egfr_cognate_redocking_core_v1.tar.gz"
diagnostic_archive="$output_root/stage13f_egfr_cognate_redocking_diagnostics_v1.tar.gz"
failure_archive="$output_root/stage13f_egfr_cognate_redocking_failed_runtime_v1.tar.gz"
...
"$python_bin" \
  -m scripts.experimental.unidock.run_stage13f_egfr_cognate_redocking \
  --config "$config" \
  --audit-only
