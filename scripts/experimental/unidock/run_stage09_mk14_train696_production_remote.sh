...
run_dir="results/runs/stage09_mk14_train696_unidock113_production"
progress="$run_dir/progress.json"
summary="$run_dir/summary.json"
audit="data/stage09_mk14_train696_unidock113_production_audit.json"
...
receptor_manifest="data/processed/stage08c_mk14_final16_receptor_manifest.csv"
ligand_manifest="data/processed/stage09_mk14_train696_unidock_pdbqt_manifest.csv"
ligand_summary="data/stage09_mk14_train696_unidock_input_summary.json"

partition="${PARTITION_ID:-${SEED_IDS:-all}}"
partition="${partition//,/+}"
partition="${partition//[^A-Za-z0-9_+-]/_}"
core_archive="$output_root/stage09_mk14_train696_unidock113_production_core_v1.tar.gz"
diagnostic_archive="$output_root/stage09_mk14_train696_unidock113_production_diagnostics_v1.tar.gz"
checkpoint_archive="$output_root/stage09_mk14_train696_unidock113_${partition}_checkpoint_v1.tar.gz"
failure_archive="$output_root/stage09_mk14_train696_unidock113_${partition}_failed_diagnostics_v1.tar.gz"
