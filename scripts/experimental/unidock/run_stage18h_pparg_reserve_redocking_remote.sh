...
run_dir="results/runs/stage18h_pparg_posthoc_reserve_redocking"
summary="data/stage18h_pparg_posthoc_reserve_redocking_summary.json"
results="data/processed/stage18h_pparg_posthoc_reserve_redocking_results.csv"
gate_results="data/processed/stage18h_pparg_posthoc_reserve_gate_results.csv"
core_archive="$output_root/stage18h_pparg_posthoc_reserve_redocking_core_v1.tar.gz"
diagnostic_archive="$output_root/stage18h_pparg_posthoc_reserve_redocking_diagnostics_v1.tar.gz"
failure_archive="$output_root/stage18h_pparg_posthoc_reserve_redocking_failed_runtime_v1.tar.gz"
...
"$python_bin" -m scripts.experimental.unidock.run_stage18h_pparg_reserve_redocking \
