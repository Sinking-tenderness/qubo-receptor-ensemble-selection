...
run_dir="results/runs/stage08b_mk14_expanded16_replacement_redocking"
summary="data/stage08b_mk14_expanded16_replacement_redocking_summary.json"
audit="data/stage08b_mk14_expanded16_replacement_redocking_audit.json"
replacement_manifest="data/processed/stage08b_mk14_replacement_receptor_manifest.csv"
final_manifest="data/processed/stage08b_mk14_expanded16_final_receptor_manifest.csv"
results_csv="data/processed/stage08b_mk14_replacement_redocking_results.csv"
core_archive="$output_root/stage08b_mk14_expanded16_replacement_redocking_core_v1.tar.gz"
diagnostic_archive="$output_root/stage08b_mk14_expanded16_replacement_redocking_diagnostics_v1.tar.gz"
failure_archive="$output_root/stage08b_mk14_expanded16_replacement_redocking_failed_diagnostics_v1.tar.gz"
