"""Build a focused Stage 07b pose archive for warning-affected batches."""
...
def diagnostic_paths(
    ...
    affected = [
        ...
        if int(row["engine_warning_count"]) > 0
    ...
    fixed = [
        ...
        str(outputs["profile_summary_csv"]),
        ...
        affected_metadata.append(
            {
                ...
                "engine_warning_count": int(row["engine_warning_count"]),
...
def main() -> int:
    ...
    result.update(
        {
            "operation": "Stage 07b warning-focused pose diagnostics bundle",
